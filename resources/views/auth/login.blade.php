...
<style>
    body {
        ...
        background-image: url('{{ asset('default_images/Atner.jpg') }}'); /* Remplacez 'your-image.jpg' par le nom de votre image */
        ...
        <div class="text">
            ...
            <form id="login-form" action="{{ route('auth') }}" method="post">
                ...
                <div class="form-group col-md-8 col-sm-10 col-12 ">
                    ...
                    <input type="password" class="form-control m-lg-2 @error('password') is-invalid @enderror" id="password"
                           name="password">
                    @error('password')
                    <div id="validationServer03Feedback" class="invalid-feedback">
                        {{ $message }}.
