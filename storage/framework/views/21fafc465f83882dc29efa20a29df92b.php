            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <img src="<?php echo e(asset('default_images/monimage.jpg')); ?>" alt=""
                                 style="height: 50px; width: 50px; border-radius: 50%;">
            ...
            <div>
                <form action="<?php echo e(route('employee.index')); ?>" method="GET" class="d-flex float-start">
                    ...
                    <div class="btn-group" role="group" class="mb-3"> <!-- Bootstrap margin bottom class -->
                        ...
                        <a href="<?php echo e(route('employee.index')); ?>" class="btn btn-outline-dark">
                    ...
                    <select name="salary_sort" class="form-select ms-2">
                        ...
                        <option value="asc" <?php echo e(request('salary_sort') == 'asc' ? 'selected' : ''); ?>>Ascending
                        </option>
                        <option value="desc" <?php echo e(request('salary_sort') == 'desc' ? 'selected' : ''); ?>>Descending
                        </option>
                    </select>
                    <div class="dropdown ms-2">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('employees.statistics')); ?>"> <i
                                        class="fas fa-chart-bar"></i> Statistics</a>
                            </li>
                            <li><a class="dropdown-item" href="<?php echo e(route('employees.terminated')); ?>"><i
                                        class="fas fa-ban"></i>
                                    Terminated</a>
                            </li>
                        </ul>
...
<?php /**PATH C:\xampp\htdocs\Laravel\HRMS\resources\views/private/employee/index.blade.php ENDPATH**/ ?>