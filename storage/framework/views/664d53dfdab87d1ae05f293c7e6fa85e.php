...
<section class="home-section" style="margin-bottom: 500px">
    ...
    <div class="mycontent">
        ...
        <div class="container-sm mt-5">
            <form class="row g-3 needs-validation" action="<?php echo e(route('trainee.update', $data->id)); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>" id="position" name="position">
                        <option value="<?php echo e($data->position->id); ?>"><?php echo e($data->position->name ?: 'Select position'); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="salary" name="salary" value="<?php echo e($data->salary); ?>">
...
unset($__errorArgs, $__bag); ?>" id="emergency_contact" name="emergency_contact" value="<?php echo e($data->emergency_contact); ?>">
...
unset($__errorArgs, $__bag); ?>" id="cv" name="cv" accept=".pdf">
                    <?php $__errorArgs = ['cv'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\xampp\htdocs\Laravel\HRMS\resources\views/private/trainee/edit.blade.php ENDPATH**/ ?>