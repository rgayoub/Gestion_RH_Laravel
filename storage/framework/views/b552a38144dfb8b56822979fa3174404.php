...
<section class="home-section" style="margin-bottom: 500px">
    ...
    <div class="mycontent">
        ...
        <div class="container-sm mt-5">
            <form class="row g-3 needs-validation" action="<?php echo e(route('employee.update', $data->id)); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>"
                        id="validationServer01" value="<?php echo e($data->first_name); ?>" name="first_name">
...
unset($__errorArgs, $__bag); ?>"
                        id="validationServer02" value="<?php echo e($data->last_name); ?>" name="last_name">
...
unset($__errorArgs, $__bag); ?>"
                        id="validationServer03" value="<?php echo e($data->national_id); ?>" name="national_id">
...
unset($__errorArgs, $__bag); ?>"
                        id="date_of_birth" name="date_of_birth" value="<?php echo e($data->date_of_birth); ?>">
...
unset($__errorArgs, $__bag); ?>" id="nationality"
                        name="nationality">
                        <option value="<?php echo e($data->nationality); ?>"><?php echo e($data->nationality ?: 'Select Nationality'); ?>
...
unset($__errorArgs, $__bag); ?>"
                        id="phone_number" name="phone_number" value="<?php echo e($data->phone_number); ?>">
...
unset($__errorArgs, $__bag); ?>" id="position" name="position">
                        <option value="<?php echo e($data->position->id); ?>"><?php echo e($data->position->name ?: 'Select position'); ?>
...
unset($__errorArgs, $__bag); ?>" id="salary"
                        name="salary" value="<?php echo e($data->salary); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        id="emergency_contact" name="emergency_contact" value="<?php echo e($data->emergency_contact); ?>">
...
unset($__errorArgs, $__bag); ?>
                    <?php if($data->cv): ?>
                        <div>
                            <a href="<?php echo e(asset('storage/' . $data->cv)); ?>" target="_blank">View Current CV</a>
                        </div>
                    <?php endif; ?>
                </div>
...
unset($__errorArgs, $__bag); ?>
                    <?php if($data->cv): ?>
                        <div>
                            <a href="<?php echo e(asset('storage/' . $data->image)); ?>" target="_blank">View Current image</a>
                        </div>
                    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\Laravel\HRMS\resources\views/private/employee/edit.blade.php ENDPATH**/ ?>